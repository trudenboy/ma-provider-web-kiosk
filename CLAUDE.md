...
This file aligns development of the **Web Kiosk** provider with the
...
provider (someone editing `music_assistant/providers/web_kiosk/` directly in
...
`music_assistant/providers/web_kiosk` upstream eventually — that is the
